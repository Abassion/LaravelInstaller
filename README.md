...
|`public/installer/assets`|This folder contains a css folder and inside of it you will find a `style.css` file, this file is responsible for the styling of your installer, you can overide the default styling and add your own.|
